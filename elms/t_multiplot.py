...
ax1.plot(b_time, b, color ='purple', label=r'bolo/topo $\cdot 10^{-7}$')
ax1.plot(p_time, p_out, color ='magenta', label='edg8/tbeo')
ax1.legend()
...
ax2.plot(b2_time, b2, color='purple')
ax2.plot(p2_time, p2, color='magenta')
...
ax3.plot(arrb2_time, arrb2_val, color='purple')
ax3.plot(arrp2_time, arrp2_val, color='magenta')
...
for i in range(0, len(arrb2_time)-1):
    rapp=arrb2_val[i]/arrb2_val[i+1]
...
for i in range(0, len(arrp2_time)-1):
    rapp=arrp2_val[i]/arrp2_val[i+1]
...
ax4.plot(vectb2_time, vectb2_val, color='purple')
ax4.plot(vectp2_time, vectp2_val, color='magenta')
...
ax5.plot(b3_time, b3, color='purple')
ax5.plot(p3_time, p3, color='magenta')
...
ax6.plot(arrb3_time, arrb3_val, color='purple')
ax6.plot(arrp3_time, arrp3_val, color='magenta')
...
for i in range(0, len(arrb3_time)-1):
    rapp=arrb3_val[i]/arrb3_val[i+1]
...
for i in range(0, len(arrp3_time)-1):
    rapp=arrp3_val[i]/arrp3_val[i+1]
...
ax7.plot(vectb3_time, vectb3_val, color='purple')
ax7.plot(vectp3_time, vectp3_val, color='magenta')
