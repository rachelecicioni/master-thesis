...
ax1.plot(b_time, b, color ='orangered', label=r'bolo/topo $\cdot 10^{-7}$')
ax1.plot(p_time, p_out, color ='orange', label='edg8/tbeo')
ax1.legend()
...
ax2.plot(b2_time, b2, color='orangered')
ax2.plot(p2_time, p2, color='orange')
...
ax3.plot(arrb2_time, arrb2_val, color='orangered')
ax3.plot(arrp2_time, arrp2_val, color='orange')
...
ax4.plot(vectb2_time, vectb2_val, color='orangered')
ax4.plot(vectp2_time, vectp2_val, color='orange')
...
ax5.plot(b3_time, b3, color='orangered')
ax5.plot(p3_time, p3, color='orange')
...
ax6.plot(arrb3_time, arrb3_val, color='orangered')
ax6.plot(arrp3_time, arrp3_val, color='orange')
...
ax7.plot(vectb3_time, vectb3_val, color='orangered')
ax7.plot(vectp3_time, vectp3_val, color='orange')
